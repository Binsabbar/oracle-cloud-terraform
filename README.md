...
* Abdullah Bin Rasheed [Twirlyz](https://github.com/Twirlyz) (dns/network modules)
...
* Bashayr Altanam [BYAT](https://github.com/BYAT) (v2.13.0 object-storage/network modules)